# 🔐 START HERE: Magic Link Email Setup
...
2. ✅ Paste your custom HTML template in Supabase dashboard
...
📄 **`MAGIC_LINK_QUICK_SETUP.md`**
- Step-by-step instructions
- Copy-paste ready HTML
- Get it working fast!

### For Detailed Explanation:
📄 **`MAGIC_LINK_CUSTOM_EMAIL_SETUP.md`**
...
Go to: [Supabase Dashboard](https://supabase.com/dashboard) → **Settings** → **Auth** → **SMTP**
...
In same **Auth** page → **Email Templates** → **Magic Link**
...
## 🤔 Why Can't We Use a Netlify Function?
...
✅ **Professional "Sign In to Base Prop" button**
✅ **Security notice** (expires in 1 hour)
✅ **Fallback URL** for accessibility
✅ **Professional footer** with branding
✅ **Mobile responsive** design
✅ **Matches your organization invitation emails!**
...
### Email not arriving?
- Check `MAGIC_LINK_CUSTOM_EMAIL_SETUP.md` → Troubleshooting section
...
**Setup Guides:**
- 🚀 `MAGIC_LINK_QUICK_SETUP.md` - **START HERE**
- 📖 `MAGIC_LINK_CUSTOM_EMAIL_SETUP.md` - Detailed guide
- 🎨 `MAGIC_LINK_BEFORE_AFTER.md` - See what you'll get

**Technical Docs:**
- 📄 `MAGIC_LINK_SETUP.md` - Alternative approaches
- 📧 `MAGIC_LINK_EMAIL_PREVIEW.md` - Email preview
- 🔧 `RESEND_SETUP_GUIDE.md` - General Resend setup

**Template File:**
- 📄 `SUPABASE_MAGIC_LINK_TEMPLATE.html` - Your HTML template

---

## 🎯 Next Step

👉 **Open `MAGIC_LINK_QUICK_SETUP.md` now** and follow the 3 steps!

You'll have beautiful magic link emails in 5 minutes. 🚀
