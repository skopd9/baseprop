  ...
  return (
    <div className="flex-1 p-6 overflow-auto bg-gray-50">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Overview of your real estate portfolio performance</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{formatCurrency(totalAppreciation)}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          {/* Simple Map */}
          <SimpleMap height="384px" properties={properties} />
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {workflowInstances.slice(0, 5).map((workflow) => (
              <div key={workflow.id} className="flex items-start space-x-3">
