...
export const SimplifiedLandlordApp: React.FC<SimplifiedLandlordAppProps> = ({ 
  ...
  // Lease parser modal state
  const [showLeaseParserModal, setShowLeaseParserModal] = useState(false);
  ...
  return (
    <div className="flex h-screen bg-white relative">
        ...
        <div className="bg-white border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between h-12 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              {/* Lease Parser Button */}
              <button
                onClick={() => setShowLeaseParserModal(true)}
                className="p-2 rounded-md text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-all"
      ...
      {/* Lease Parser Modal */}
      <LeaseParserModal
        isOpen={showLeaseParserModal}
        onClose={() => setShowLeaseParserModal(false)}
        mode="standalone"
      />
    </div>
  );
